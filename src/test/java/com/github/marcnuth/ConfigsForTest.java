...
public class ConfigsForTest {
    ...
    public final static String FILE_SERVER_JKS = ConfigsForTest.class.getClassLoader().getResource("server_test.jks").getPath();
    public final static String STOREPASS_SERVER_CERT = "testcase";
    public final static String KEYPASS_SERVER_CERT = "testcase";
    public final static String FILE_SERVER_TRUST_CERT = ConfigsForTest.class.getClassLoader().getResource("server_trust_test.jks").getPath();
    public final static String PWD_SERVER_TRUST_CERT = "testcase";


    public final static String FILE_CLIENT_JKS = ConfigsForTest.class.getClassLoader().getResource("client_test.jks").getPath();
    public final static String STOREPASS_CLIENT_CERT = "testcase";
    public final static String KEYPASS_CLIENT_CERT = "testcase";
    public final static String FILE_CLIENT_TRUST_CERT = ConfigsForTest.class.getClassLoader().getResource("client_trust_test.jks").getPath();
